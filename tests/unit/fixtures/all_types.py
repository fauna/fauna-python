...
fixture_typed_string = '{"bugs_coll": {"@mod": "Bugs"}, "bug": {"@doc": "Bugs:123"}, "name": "fir", "age": {"@int": ' \
                       ...
                       '"circumference": {"@double": "3.82"}, "created_at": {"@time": "2003-02-08T13:28:12.000555+00:00"}, ' \
                       '"extras": {"nest": {"@object": {"num_sticks": {"@int": "58"}, "@extras": {"egg": {' \
                       '"fertilized": false}}}}}, "measurements": [{"id": {"@int": "1"}, "employee": {' \
                       '"@int": "3"}, "time": {"@time": "2013-02-08T12:00:05.000123+00:00"}}, {"id": {"@int": "2"}, ' \
                       '"employee": {"@int": "5"}, "time": {"@time": "2023-02-08T14:22:01.000001+00:00"}}]}'
